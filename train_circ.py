...
#da ne treniras iz nule
#model = PPO.load("./models/PPO05/1420000", env=env)     
...
while True:
    iters += 1
    model.learn(total_timesteps=TIMESTEPS, reset_num_timesteps=False,tb_log_name="PPO_goal1")
